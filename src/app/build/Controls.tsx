...
export default function Controls({
  ...
  }, [router, selectedWheel, selectedTruck, selectedDeck, selectedBolt]);
    ...
    <div className="">
      <div className="flex">
        ...
        <p className="ml-3 text-zinc-300">
          <span className="selecte-none text-zinc-500">| </span>
          {formattedName}
        </p>
      </div>
...
type OptionProps = Omit<ComponentProps<"button">, "children"> & {
  ...
  onClick: () => void;
    ...
    | { colorField: ColorField; imageField?: never; imgixParams?: never }
  );
