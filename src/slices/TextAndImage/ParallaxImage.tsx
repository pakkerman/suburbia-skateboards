...
export default function ParallaxImage({
  ...
  useEffect(() => {
    ...
    function onMouseMove(event: MouseEvent) {
      ...
      const xPercent = (event.clientX / innerWidth - 0.5) * 2; // between -1 and 1
      const yPercent = (event.clientY / innerHeight - 0.5) * 2; // between -1 and 1
    ...
    function animationFrame() {
      ...
      if (foregroundRef.current) {
        foregroundRef.current.style.transform = `translate(${newX * 2.5}px, ${newY}px)`;
      }
